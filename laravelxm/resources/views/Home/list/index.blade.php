...
<div  class="g">
    <div  class="fl u-3-4"> 
        ...
        <div  class="g-l g-l-none">
		    ...
		    <h2><a  href="/home/list/{{ $cate->category_id }}"  title="">{{ $cate->category_name }}</a></h2>
...
<volist name="list_goods" id="vo">
			...
			<div style="float:left;">
				...
				<p  class="p-name">
				<a  href="/home/goodinfo/{{ $v->goods_id}}"  title="{$vo.goods_keywords}"  target="_blank">{{ $v->goods_name }}<span  class="red"></span></a></p>
