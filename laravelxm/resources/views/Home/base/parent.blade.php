...
@section('body')
	...
	<div class="mc-menu-area">
		<div class="h"><a href="{{ url('home/member') }}" class="button-go-mc" title="个人中心"><span>个人中心</span></a></div>
		<div class="b">
			<ul>
				<li>
				<h3>订单中心</h3>
					<ol>
						<li id="li-order"><a href="{{ url('home/order') }}" title="我的订单"><span>我的订单</span></a></li>
				...
				<h3>个人中心</h3>
					<ol>
						<li id="li-account"><a href="{{ url('home/personal') }}" title="个人信息"><span>个人信息</span></a></li>
						<li id="li-security"><a href="{{ url('home/pwd') }}" title="密码管理"><span>密码管理</span></a></li>
						<li id="li-balance" ><a href="{{ url('home/account') }}" title="账户余额"><span>账户余额</span></a></li>
						<li id="li-myAddress"><a href="{{ url('home/address') }}" title="收货信息"><span>收货信息</span></a></li>
				...
				<h3>社区中心</h3>
					<ol>
						<li id="li-prdRemark"><a href="{{ url('home/comment') }}" title="商品评价"><span>商品评价</span></a></li>
					</ol>
				</li>
			</ul>
		</div>
